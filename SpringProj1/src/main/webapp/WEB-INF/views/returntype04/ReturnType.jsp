...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>스프링<small>컨트롤러 메서드의 반환타입</small></h1>
			<fieldset>
				...
				<ul>
					...
					<li><a href="<c:url value="/ReturnType/Void.do?returnType=void!!!"/>">void(@Controller어노테이션 사용시 Ajax나 RestAPI로 구현시 주로 사용)반환</a></li>
				</ul>
				<h2>결과값 출려</h2>
				
				<ul>
					<li>\${message } : ${message}</li>	
					<li>\${returnType } : ${returnType}</li>	
