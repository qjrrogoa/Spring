...
<body>
	...
	<div class="container">
		...
		<fieldset>
			...
			<h2>&lt;resources&gt;태그 미사용 : &lt;default-servlet-handler/&gt; - 디렉토리 구조로 매핑</h2>
			<img src="<c:url value="/resources/images/sumnail.png"/>" alt="디렉토리 구조로 접근"/>
		</fieldset>
		...
		<fieldset>
			...
			<ul style="list-style: decimal;">
				...
				<li><a href="<c:url value='/viewresolver.do'/>">뷰 리졸브</a></li>
