...
<body>
	...
	<div class="container">
		<div class="page-header">
			<h1>스프링<small>Annotation</small></h1>
			<fieldset>
				<legend>어노테이션</legend>
				...
				<fieldset>
					...
					<h4>@RequestMapping("/요청 URL패턴") : GET/POST 둘다 처리 가능</h4>
					<form method="get" action="<c:url value='/Annotation/RequestMappingBoth.do'/>">
						아이디 <input type="text" name="UserID" />
						비번 <input type="password" name="UserPWD" />
						<input type="submit" value="로그인" />
					</form>
					<h4>@RequestMapping(value="/요청URL패턴",method=RequestMethod.GET) : GET/POST 둘중 하나만 처리 가능</h4>
					<h4>둘다 보내려면 method = {RequestMethod.GET, RequestMethod.POST} 사용</h4>
...
-->
				...
				<fieldset>
					...
					<h4><a href="<c:url value="/Annotation/RequestBody.do"/>">@RequestBody</a></h4>
